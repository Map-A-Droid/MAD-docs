...
1. Install [PogoDroid](https://www.maddev.eu/apk/PogoDroid.apk) on your device
2. To login to PogoDroid you need to purchase a license from the [MADDev shop](https://maddev.eu/) and follow the instructions.
3. Once logged into the [backend](http://auth.maddev.eu/), click "Password management" on the top
...
6. Now it is time to configure PogoDroid.
