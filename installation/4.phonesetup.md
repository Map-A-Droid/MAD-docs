...
1. Install [PogoDroid](https://www.maddev.de/apk/PogoDroid.apk) on the phone.

2. To login to PogoDroid you need to be a [Patreon supporter](https://www.patreon.com/user?u=14159560).The 2$ tier is enough for mapping.

3. Visit the [reauth URL](http://tinyurl.com/madauth), this page will tell you to copy a password and API Token. Copy both and put them in a notepad (if you don't have a notepad app, now is the time to get one).
