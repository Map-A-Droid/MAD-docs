...
>The article [Config File](2.config-file.md) has more detailed descriptions about the available options.
...
Have a look at [Mappings](/installation/3.mappings.md) to understand how this works.
